  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center px-6 text-center">
      <h1 className="text-5xl font-bold tracking-tight text-slate-100">
        Vault<span className="text-brand">Layer</span>
      </h1>
      ...
      <div className="mt-16 grid max-w-3xl grid-cols-3 gap-6 text-left">
        <Feature
          icon="🔐"
          title="Zero-knowledge to platform"
          body="Source code is encrypted client-side with AES-256-GCM before upload. VaultLayer never sees your code."
        />
        <Feature
          icon="⛓"
