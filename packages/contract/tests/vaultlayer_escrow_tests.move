#[test_only]
module vaultlayer::escrow_tests {

    use std::string;
    use aptos_framework::timestamp;
    use aptos_framework::account;
    use vaultlayer::escrow;
    ...
    #[test(aptos = @aptos_framework, vaultlayer = @vaultlayer, vendor = @0xA)]
    fun test_create_agreement_ok(
        ...
        escrow::init_module_for_test(&vaultlayer);
    ...
    #[test(aptos = @aptos_framework, vaultlayer = @vaultlayer, vendor = @0xA, buyer = @0xB)]
    ...
    #[test(aptos = @aptos_framework, vaultlayer = @vaultlayer, vendor = @0xA, caller = @0xC)]
    ...
    #[test(aptos = @aptos_framework, vaultlayer = @vaultlayer, vendor = @0xA, buyer = @0xB, caller = @0xC)]
